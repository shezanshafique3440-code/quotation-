...
export const ACTIVITY_KINDS = {
  ...
  emailVerificationSent: "security.email_verification_sent",
  emailVerified: "security.email_verified",
  memberInvited: "security.member_invited",
  memberJoined: "security.member_joined",
  memberRemoved: "security.member_removed",
  memberRoleChanged: "security.member_role_changed",
  invitationRevoked: "security.invitation_revoked",
